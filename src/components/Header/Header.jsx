  ...
  return (
    <header className="flex items-center justify-between">
      ...
      <button
        ...
        className="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 text-lg backdrop-blur-sm ring-1 ring-white/20 transition hover:bg-white/20"
      >
        🔍
      </button>
    </header>
