...
export default function HourlyItem({ time, temp, weatherCode, isCurrent }) {
  ...
  return (
    <li className={`flex flex-col items-center gap-2 text-sm px-4 py-3 w-16 shrink-0 snap-center rounded-2xl  ${isCurrent ? 'border-2 border-[#8bb6da] bg-[#DDF0FF]' : 'bg-white'}`}>
